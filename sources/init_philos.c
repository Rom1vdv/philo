...
/*   Updated: 2023/05/16 13:00:09 by romvan-d         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "philo.h"

static int	allocate_threads_memory(t_philo **array_of_philos, t_philo_datas *philo_datas)
{
	int thread_index;
...
int	create_threads(t_philo_datas *philo_datas, t_philo **array_of_philos)
{
	...
	allocate_threads_error = allocate_threads_memory(array_of_philos, philo_datas);
